...
class UNET_1D(nn.Module):
    def __init__(self, input_dim, layer_n, kernel_size, depth, n_classes):
...
class UNET_Predictor(pl.LightningModule):
    def __init__(self, n_features: int, n_classes: int, layer_n: int, kernel_size: int, depth: int):
        super().__init__()
        self.model = UNET_1D(n_features, layer_n, kernel_size, depth, n_classes)
    ...
    def training_step(self, batch, batch_idx):
        ...
        predictions = torch.argmax(outputs, dim=240)
